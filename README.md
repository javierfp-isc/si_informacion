# Entorno para prácticas de sistemas de archivos
...
- **sa_crear**: creación de un container para ejecutar las prácticas
...
Si el nombre del container es **sa_crear_sa_1** accederemos a él con:

`docker exec -it sa_crear_sa_1 bash`
